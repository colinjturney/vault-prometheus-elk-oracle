...
readonly VAULT_PLUGINS_DIR_PATH="/etc/vault.d/plugins"
readonly VAULT_VERSION="1.7.0"
...
function install_vault {
  ...
  curl -s -o vault.zip https://releases.hashicorp.com/vault/1.7.0/vault_1.7.0_linux_amd64.zip
...
plugin_directory = "${VAULT_PLUGINS_DIR_PATH}"
...
function main {
  ...
  sudo rm -rf "${TMP_DIR}"
  mkdir -p "${VAULT_PLUGINS_DIR_PATH}"
